...
import { LayoutDashboard, ShoppingCart, Armchair, ScanLine, LogOut, FileSpreadsheet, Package, FileBarChart, Settings } from 'lucide-react';
    ...
    <>
      ...
      `}>
        <div className="p-6 border-b border-primary-800">
          ...
          <p className="text-xs text-primary-200 mt-1">Enterprise Edition v1.2</p>
        </div>
